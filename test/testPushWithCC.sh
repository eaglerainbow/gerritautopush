...
echo "*** Running test Push including CC users"
...
$SUBJECT -s -c -m "Change-Id:  dummy commit message" -p origin -b master -o dummyuser@example.bogus -g $PWD/../../git_push_cc.sh
