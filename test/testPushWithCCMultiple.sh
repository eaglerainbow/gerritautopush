...
. ./infra.inc
TESTDIR=pushWithCCMultiple

echo "*** Running test Push including multiple CC users"
...
$SUBJECT -s -c -m "Change-Id:  dummy commit message" -p origin -b master -o dummyuser@example.bogus -o dummyuser2@example.bogus -g $PWD/../../git_push_cc_multiple.sh
