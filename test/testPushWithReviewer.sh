...
. ./infra.inc
TESTDIR=pushWithReviewer

echo "*** Running test Push including reviewer"
...
$SUBJECT -s -c -m "Change-Id:  dummy commit message" -p origin -b master -v dummyuser@example.bogus -g $PWD/../../git_push_reviewer.sh
